...
def _parse_time(value: object) -> datetime | None:
    """Parse an ISO 8601 stamp into an *aware* datetime.

    Crawler manifests carry a KST offset, but NARA_INDEX_BUILT_AT is supplied by
    hand and is often naive.  Comparing the two raised TypeError and disabled the
    whole check, so a naive stamp is read as local time to keep comparisons total.
    """

...
import { initialNodes, initialEdges } from './data/initialFlow.js';
import { MINIMAP_NODE_COLORS, NODE_DEFAULTS } from './data/workflowNodeDefinitions.js';
...
export default function App() {
  ...
  const minimapColor = (node) => {
    return MINIMAP_NODE_COLORS[node.type] ?? '#22c55e';
  };

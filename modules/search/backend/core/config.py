...
# BM25 표준 파라미터와 BM25F 근사 필드 반복 가중치.
BM25_K1 = 1.2
BM25_B = 0.75
BM25_FIELD_WEIGHTS = (
    ("title", 3),
...
# OpenAPI JSON 데이터 — 저장소 공통 루트 api_storage의 openapi_new 폴더
# ({api_id}.json 평면, nara_crawler가 생산). env로 오버라이드 가능.
APIDATA_DIR = _env_path("NARA_SEARCH_APIDATA_DIR", PROJECT_ROOT / "api_storage" / "openapi_new")
...
BUILD_MANIFEST_PATH = STORAGE_DIR / "build_manifest.json"
